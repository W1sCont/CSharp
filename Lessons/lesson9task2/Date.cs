...
namespace lesson8task3
{
    ...
    internal class Date
    {
        ...
        public int Day 
        {
            ...
            {
                // if (value < 1) day = 1;
                if (value < 1) throw new Exception("Значення не може бути менше 0");
        ...
        public int Month
        {
            ...
            set 
            {
                //if (value < 1) month = 1;
                if (value < 1) throw new Exception("Значення не може бути менше 0");
                else if (value > 12) throw new ArgumentOutOfRangeException("Значення не може бути більше 12"); //month = 12;
                else month = value; 
            }
        }
        public int Year
        {
            get { return year; }
            set { year = value < 1 ? throw new Exception("Значення не може бути менше 0") : value; } // 1
        }
        ...
        {
            if (year < 0) throw new Exception("Значення не може бути менше 0");
